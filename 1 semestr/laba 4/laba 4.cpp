...
int main() {
	...
	while (k <= m) {
		fact *= k; //смысл факториала не стоит объяснять...
		k+=1; // понятно ведь....
		}
	for (int i = 0; i < n; i++) {
	...
	printf("\n");
	if (m == 0) {
		printf("0"); //частный случай (или минус моей программы) если отрицательных чисел не было изначально а факториал сразу = 1
	} else
