...
LPalette::LPalette(const uchar value, const bool isActive)
{
	palette_ = isActive ? "" : "2";
	palette_ += ('0' + value);
}
LPalette::LPalette(const uchar value, const bool isBright, const bool isBackground)
{
...
LPalette::RGB::RGB(const uchar red, const uchar green, const uchar blue)
{
	red_ = red;
	green_ = green;
	blue_ = blue;
...
LPalette LPalette::ColourTable(const uchar value, const bool isBackground)
{
