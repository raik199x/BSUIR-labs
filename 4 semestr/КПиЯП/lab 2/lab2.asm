...
.data
    ...
    start_word_pos dw -1
    ErrorMessage_overflow db "Task cannot be completed - the final result > 200 db", 10, 13, '$'
...
mov cx,1
    ...
    cmp ax,di
    je Out_index_find_MainLine  ;If found - leave
...
ReplaceTo_is_bigger:
    ...
    mov di,0
    mov cx,size_replace_to-size_find_to
    move_mainline:
        mov si, start_word_pos
        add si, size_find_to
        add si, di
