...
.data
    __map__ db 29 dup('#')                                                                                              ;1
            ...
            db '#',32,32,'#',32,32,'#',32,32,32,'#',32,32,32,'#',32,32,'#',32,32,32,'#',32,32,'#',32,32,32,'#'          ;4
            db '#',32,32,'#',32,32,'#',32,32,32,'#','#',32,32,'#',32,32,'#',32,'#',32,'#',32,32,'#','#','#',32,'#'      ;5
            ...
            db '#',5 dup(32),'#',32,32,32,'#',32,32,32,'#',9 dup(32),'#',32,32,32,'#'                                   ;11
            db '#',32,32,32,32,'#',13 dup(32),'#','#','#',32,32,'#','#','#',32,'#'                                      ;12
...
start:
    ...
    ;mov ah,1     ;check if keyboard was pressed
    ;int 16h
    ;jnz key_was_pressed
    ;jmp RE_MAP
    ;key_was_pressed:
